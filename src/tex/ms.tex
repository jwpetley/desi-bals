...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/six_micron_z.pdf}
    \caption{Kernel density estimates for the BI BALQSOs and QSOs before and after 2d matching in $L_{6\mu m} - z $ space.}
    \label{fig:matching}
    \script{matching_figures.py}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/matched_detection_fraction.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/flux_bi.pdf}
    \caption{Correlation between radio flux and BI }
    \label{fig:flux_bi}
    \script{correlations.py}
\end{figure}
